...
# Compared to CABLEplotsComp.R, this version have check%ranges=.FALSE.
...
gen_test=function(infiles,sitenames,outtype,plottypes,oldfiles){
...
seasflux=function(outtype='pdf',sitename,cablefile,obsfile,oldfile){
  ...
  # legend(1,max(maxcable,maxobs),c('CABLE','last version','obs'),lty=1,
  #        col=c('salmon','green','black'),lwd=2,bty="n")
  # Close netcdf files
  close.ncdf(cnc)
  close.ncdf(onc)
...
diurnalflux = function(outtype,sitename,cablefile,obsfile,oldfile){
  ...
  legend(-2,max(cmax,omax),c('new model','old model','obs'),lty=1,
         col=c('salmon','green','black'),lwd=2,bty="n")
  # legend(-2,max(cmax,omax),c('CABLE','last version','obs'),lty=1,
  #        col=c('salmon','green','black'),lwd=2,bty="n")
  # Close netcdf files
  close.ncdf(cnc)
  close.ncdf(onc)
