subroutine read_real_3d(file, variable, nx, ny, nz, data, title)

! Purpose
! -------
! Generic routine to read a three-dimensional real array from a netCDF file.
!
! Arguments
! --------
...
! History
! -------
! 2008 Feb 3	Steven Phipps	Original version
  ...
  real, dimension(nx, ny, nz), intent(out) :: data
