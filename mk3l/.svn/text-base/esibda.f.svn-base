...
C
C     This uses the ice values below 0 degrees C. Elsewhere, it is the 
C     same as the regular esbda.f, which uses values linearly 
C     interpolated b/w the ice and liquid values b/w 0C and -20C. (LDR 11/98)
C                                                                      ! TEMP
      common /esitable/ tablei(0:220)
      data (tablei(i),i=0,99) /1.e-9, 1.e-9, 2.e-9, 3.e-9, 4.e-9,      !-146C
